...
void marishin::isoScale(Shape *shape, point_t center, double coefficient)
{
  if (coefficient <= 0.0)
  {
  ...
  {
    isoBaseScale(shape, center, coefficient);
  }
}

void marishin::isoBaseScale(Shape *shape, point_t center, double coefficient)
{
